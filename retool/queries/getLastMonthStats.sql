-- getLastMonthStats.sql
-- Comprehensive KPI statistics for the previous calendar month (MoM comparison)
-- Retool variables: none

SELECT
  TO_CHAR(DATE_TRUNC('month', NOW()) - INTERVAL '1 month', 'Month YYYY') AS month_label,
